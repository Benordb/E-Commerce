        ...
        <div className="flex gap-6 w-full mx-6">
            <div className="flex-1">
                <div className="h-36 flex flex-col justify-between bg-white my-8 rounded-xl px-6 py-4">
                    <div className="font-semibold flex items-center gap-2"><FaDollarSign />Орлого</div>
            ...
            <div className="flex-1">
                <div className="h-36 flex flex-col justify-between bg-white my-8 rounded-xl px-6 py-4">
                    <div className="font-semibold flex items-center gap-2"><FaRegClipboard />Захиалга</div>
